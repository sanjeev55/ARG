...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    ...
    <li class="nav-item">
        <g:link controller="subject" action="searchByName"
                class="nav-link js-scroll-trigger">Search By Name</g:link>
    </li>
    <li class="nav-item">
        <g:link controller="subject" action="searchByFaculty"
                class="nav-link js-scroll-trigger">Search By Faculty</g:link>
    </li>
    <li class="nav-item">
        <g:link controller="subject" action="searchBySemester"
                class="nav-link js-scroll-trigger">Search By Semester</g:link>
    </li>
    <li class="nav-item">
        <g:link controller="subject" action="searchByFacultyAndSemester"
