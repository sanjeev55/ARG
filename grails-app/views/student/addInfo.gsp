...
<!-- You only need this form and the form-basic.css -->
    ...
    <g:form class="form-basic" method="post" controller="student" action="addInfo1" >
        ...
        <div class="form-row">
            <label>
                ...
                <input type="text" name="noOfStudents">
            </label>
        </div>
    ...
    <div class="form-basic">
        <g:link controller="student" action="viewInfo"
                style="text-decoration: none"><button>View Class Information</button></g:link>
    </div>
